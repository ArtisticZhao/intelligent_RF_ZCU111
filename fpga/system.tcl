...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:axi_bpsk_ctrl:1.0\
xilinx.com:ip:axi_bram_ctrl:4.1\
xilinx.com:ip:smartconnect:1.0\
xilinx.com:ip:blk_mem_gen:8.4\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:user:rf_sin_gen_v1_0_M_AXIS:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set reset_rf [ create_bd_port -dir I -from 0 -to 0 reset_rf ]

  # Create instance: axi_bpsk_ctrl_0, and set properties
  set axi_bpsk_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_bpsk_ctrl:1.0 axi_bpsk_ctrl_0 ]
  ...
  # Create instance: rf_sin_gen_v1_0_M_AX_0, and set properties
  set rf_sin_gen_v1_0_M_AX_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:rf_sin_gen_v1_0_M_AXIS:1.0 rf_sin_gen_v1_0_M_AX_0 ]
  ...
  connect_bd_intf_net -intf_net axi_bpsk_ctrl_0_BRAM_PORT [get_bd_intf_pins axi_bpsk_ctrl_0/BRAM_PORT] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_bpsk_ctrl_0/S00_AXI] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net dac1_clk_1 [get_bd_intf_ports dac1_clk] [get_bd_intf_pins usp_rf_data_converter_0/dac1_clk]
  connect_bd_intf_net -intf_net rf_sin_gen_v1_0_M_AX_0_M_AXIS [get_bd_intf_pins rf_sin_gen_v1_0_M_AX_0/M_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s12_axis]
  ...
  connect_bd_net -net Net [get_bd_pins axi_bpsk_ctrl_0/rst_n] [get_bd_pins proc_sys_reset_128M/peripheral_aresetn] [get_bd_pins rf_sin_gen_v1_0_M_AX_0/M_AXIS_ARESETN] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn]
  connect_bd_net -net Op1_0_1 [get_bd_ports reset_rf] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net axi_bpsk_ctrl_0_gen_en [get_bd_pins axi_bpsk_ctrl_0/gen_en] [get_bd_pins rf_sin_gen_v1_0_M_AX_0/gen_en]
  connect_bd_net -net axi_bpsk_ctrl_0_interrupt_num [get_bd_pins axi_bpsk_ctrl_0/interrupt_num] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net axi_bpsk_ctrl_0_phase_ctrl [get_bd_pins axi_bpsk_ctrl_0/phase_ctrl] [get_bd_pins rf_sin_gen_v1_0_M_AX_0/phase_ctrl]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bpsk_ctrl_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins axi_bpsk_ctrl_0/clk] [get_bd_pins proc_sys_reset_128M/slowest_sync_clk] [get_bd_pins rf_sin_gen_v1_0_M_AX_0/M_AXIS_ACLK] [get_bd_pins usp_rf_data_converter_0/clk_dac1] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins proc_sys_reset_128M/ext_reset_in] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bpsk_ctrl_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bpsk_ctrl_0/S00_AXI/S00_AXI_reg] SEG_axi_bpsk_ctrl_0_S00_AXI_reg
